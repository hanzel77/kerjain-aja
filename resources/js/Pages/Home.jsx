                    ...
                    <div className='h-screen'>
                        <div className='relative w-full h-full'>
                            ...
                            <img
                                ...
                                alt="Sekelompok orang sedang berdiskusi"
                        ...
                        <div className='max-w-6xl mx-auto px-4'>
                            ...
                            <div className='grid md:grid-cols-3 gap-8 mt-10'>
                                <div className='bg-white shadow-md border p-6 rounded-lg text-center'>
                                    <i className='fa fa-wheelchair text-tertiary text-4xl' aria-hidden="true"></i>
                                ...
                                <div className='bg-white shadow-md border p-6 rounded-lg text-center'>
                                    <i className='fa fa-shield text-tertiary text-4xl' aria-hidden="true"></i>
                                ...
                                <div className='bg-white shadow-md border p-6 rounded-lg text-center'>
                                    <i className='fa fa-users text-tertiary text-4xl' aria-hidden="true"></i>
